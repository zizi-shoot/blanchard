...
const tabWrapper = document.querySelector('.catalog__tab-wrapper');
...
function switchTab() {
	tabWrapper.classList.add('catalog__tab-wrapper--preanimated');
	...
	setTimeout(() => {
		...
		accordion.open(+period);
		tabWrapper.classList.remove('catalog__tab-wrapper--preanimated');
	}, 300);
}
